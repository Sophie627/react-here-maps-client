  ...
  render() {
    ...
    return (
        <div className="container col-md-12">
          ...
          <button type="submit" className="btn btn-info" onClick={this.onCheck}>Validar Direccion</button>
          <button type="submit" className="btn btn-outline-secondary" onClick={this.onClear}>Limpiar Datos</button>
          <button type="submit" className="btn btn-primary" onClick={() => this.enviarDatos()}>Enviar</button>
          </div>
        </div>
      );
  }
...
export default connect(mapStateToProps, { agregarDireccionCliente })(AddressForm);